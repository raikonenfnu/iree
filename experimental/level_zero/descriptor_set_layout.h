...
#ifndef IREE_HAL_LEVEL_ZERO_DESCRIPTOR_SET_LAYOUT_H_
#define IREE_HAL_LEVEL_ZERO_DESCRIPTOR_SET_LAYOUT_H_
...
#endif  // IREE_HAL_LEVEL_ZERO_DESCRIPTOR_SET_LAYOUT_H_
