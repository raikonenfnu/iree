...
typedef struct iree_hal_level_zero_executable_layout_t {
...
} iree_hal_level_zero_executable_layout_t;

static const iree_hal_executable_layout_vtable_t
    iree_hal_level_zero_executable_layout_vtable;

static iree_hal_level_zero_executable_layout_t*
iree_hal_level_zero_executable_layout_cast(
    iree_hal_executable_layout_t* base_value) {
  IREE_HAL_ASSERT_TYPE(base_value,
                       &iree_hal_level_zero_executable_layout_vtable);
  return (iree_hal_level_zero_executable_layout_t*)base_value;
}

static void iree_hal_level_zero_executable_layout_destroy(
    iree_hal_executable_layout_t* base_executable_layout) {
  iree_hal_level_zero_executable_layout_t* executable_layout =
      iree_hal_level_zero_executable_layout_cast(base_executable_layout);
...
iree_status_t iree_hal_level_zero_executable_layout_create(
    iree_hal_level_zero_context_wrapper_t* context,
    iree_host_size_t set_layout_count,
    iree_hal_descriptor_set_layout_t** set_layouts,
    iree_host_size_t push_constant_count,
  ...
  *out_executable_layout = NULL;
  ...
  iree_hal_level_zero_executable_layout_t* executable_layout = NULL;
  ...
  if (iree_status_is_ok(status)) {
    iree_hal_resource_initialize(&iree_hal_level_zero_executable_layout_vtable,
...
iree_host_size_t iree_hal_level_zero_executable_layout_num_constants(
    iree_hal_executable_layout_t* base_executable_layout) {
  iree_hal_level_zero_executable_layout_t* executable_layout =
      iree_hal_level_zero_executable_layout_cast(base_executable_layout);
...
static const iree_hal_executable_layout_vtable_t
    iree_hal_level_zero_executable_layout_vtable = {
        .destroy = iree_hal_level_zero_executable_layout_destroy,
};
