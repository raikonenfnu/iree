...
static iree_status_t iree_hal_level_zero_device_submit_and_wait(
    iree_hal_device_t* base_device,
    iree_hal_command_category_t command_categories,
    iree_hal_queue_affinity_t queue_affinity, iree_host_size_t batch_count,
    const iree_hal_submission_batch_t* batches,
  ...
  // Submit...
  IREE_RETURN_IF_ERROR(iree_hal_level_zero_device_queue_submit(
...
static const iree_hal_device_vtable_t iree_hal_level_zero_device_vtable = {
    ...
    .submit_and_wait = iree_hal_level_zero_device_submit_and_wait,
