...
#ifndef IREE_HAL_DRIVERS_ROCM_STREAM_COMMAND_BUFFER_H_
#define IREE_HAL_DRIVERS_ROCM_STREAM_COMMAND_BUFFER_H_
...
// Creates a ROCM stream command buffer that immediately issues commands against
...
// Returns true if |command_buffer| is a ROCM stream-based command buffer.
...
#endif  // IREE_HAL_DRIVERS_ROCM_STREAM_COMMAND_BUFFER_H_
