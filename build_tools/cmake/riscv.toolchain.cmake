...
if(RISCV_CPU STREQUAL "rv64")
  ...
  list(APPEND RISCV_COMPILER_FLAGS "-march=rv64gc_zfh0p1 -mabi=lp64d -menable-experimental-extensions")
...
elseif(RISCV_CPU STREQUAL "rv32-baremetal")
  ...
  set(RISCV_COMPILER_FLAGS "${RISCV_COMPILER_FLAGS} -march=rv32imf_zfh0p1 -mabi=ilp32 -DIREE_PLATFORM_GENERIC=1 -DIREE_SYNCHRONIZATION_DISABLE_UNSAFE=1 \
