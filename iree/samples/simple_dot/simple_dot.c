...
iree_status_t Run() {
  ...
  // erased buffers.
  const char kMainFunctionName[] = "module.simple_dot";
  ...
  const int kElementCount0 = 4*3;
  const int kElementCount1 = 3*6;
  ...
  iree_hal_dim_t shape0[2] = {4,3};
  iree_hal_dim_t shape1[2] = {3,6};
...
int main() {
  ...
  fprintf(stdout, "simple_dot passed\n");
  return ret;
}
