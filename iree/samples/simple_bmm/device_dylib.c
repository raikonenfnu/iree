...
#include "iree/samples/simple_bmm/simple_bmm_test_bytecode_module_dylib_arm_64_c.h"
#include "iree/samples/simple_bmm/simple_bmm_test_bytecode_module_dylib_riscv_64_c.h"
#include "iree/samples/simple_bmm/simple_bmm_test_bytecode_module_dylib_x86_64_c.h"
...
const iree_const_byte_span_t load_bytecode_module_data() {
  ...
  const struct iree_file_toc_t* module_file_toc =
      iree_samples_simple_bmm_test_module_dylib_x86_64_create();
#elif IREE_ARCH_RISCV_64
  const struct iree_file_toc_t* module_file_toc =
      iree_samples_simple_bmm_test_module_dylib_riscv_64_create();
#elif IREE_ARCH_ARM_64
  const struct iree_file_toc_t* module_file_toc =
      iree_samples_simple_bmm_test_module_dylib_arm_64_create();
#else
