...
struct GPUBreakDownLargeVectorPass final
    : public GPUBreakDownLargeVectorBase<GPUBreakDownLargeVectorPass> {
...
createGPUBreakDownLargeVectorPass() {
  return std::make_unique<GPUBreakDownLargeVectorPass>();
}
