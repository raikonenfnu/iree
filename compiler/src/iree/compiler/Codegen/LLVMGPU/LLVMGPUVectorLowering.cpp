  ...
  void runOnOperation() override {
    ...
    // dimensions across regions.
    {
      ...
      vector::populateVectorInsertExtractStridedSliceDecompositionPatterns(
          patterns);
      vector::ExtractOp::getCanonicalizationPatterns(patterns, funcOp.getContext());

      // Trimming leading unit dims may generate broadcast/shape_cast ops. Clean
      // them up.
      vector::BroadcastOp::getCanonicalizationPatterns(patterns, funcOp.getContext());
      vector::ShapeCastOp::getCanonicalizationPatterns(patterns, funcOp.getContext());
