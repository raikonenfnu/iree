...
void addSPIRVCooperativeMatrixVectorizePassPipeline(OpPassManager &pm,
  ...
  // TODO: Rework createGPUTensorTile + createGPUDistribute to replace
  // SPIRVTileToCooperativeOp.
  nestedModulePM.addNestedPass<func::FuncOp>(
  ...
  //   nestedModulePM.addNestedPass<func::FuncOp>(
  //       createGPUTensorTile(/*distributeToWarp=*/true));
  ...
  nestedModulePM.addPass(createCanonicalizerPass());
  nestedModulePM.addPass(createCSEPass());
  nestedModulePM.addNestedPass<func::FuncOp>(createCollapseNestedTiledForOpsPass());
  nestedModulePM.addNestedPass<func::FuncOp>(
