...
func.func @static_attention(%query : tensor<48x1178x64xf16>, %key : tensor<48x1178x64xf16>, %value : tensor<48x1178x64xf16>) -> tensor<48x1178x64xf16> {
  ...
  %1 = iree_linalg_ext.attention {indexing_maps = [affine_map<(d0, d1, d2, d3, d4) -> (d0, d1, d2)>,
                    ...
                    ins(%query, %key, %value, %scale : tensor<48x1178x64xf16>, tensor<48x1178x64xf16>, tensor<48x1178x64xf16>, f16) outs(%0 : tensor<48x1178x64xf16>) -> tensor<48x1178x64xf16>
...
// CHECK-SAME:                    ins(%[[PAD_Q]], %[[PAD_K]], %[[VALUE]], %[[ZERO]] : tensor<48x1216x65xf16>, tensor<48x1178x65xf16>, tensor<48x1178x64xf16>, f16)
...
func.func @dynamic_attention(%query : tensor<48x?x64xf16>, %key : tensor<48x1178x64xf16>, %value : tensor<48x1178x64xf16>) -> tensor<48x?x64xf16> {
  ...
  %1 = iree_linalg_ext.attention {indexing_maps = [affine_map<(d0, d1, d2, d3, d4) -> (d0, d1, d2)>,
                    ...
                    affine_map<(d0, d1, d2, d3, d4) -> ()>,
                    affine_map<(d0, d1, d2, d3, d4) -> (d0, d1, d4)>]}
                    ins(%query, %key, %value, %scale : tensor<48x?x64xf16>, tensor<48x1178x64xf16>, tensor<48x1178x64xf16>, f16) outs(%0 : tensor<48x?x64xf16>) -> tensor<48x?x64xf16>
...
// CHECK:        %[[ATTN:.+]] = iree_linalg_ext.attention
// CHECK-SAME:                    ins(%[[PAD_Q]], %[[PAD_K]], %[[VALUE]], %[[ZERO]] : tensor<48x?x65xf16>, tensor<48x1178x65xf16>, tensor<48x1178x64xf16>, f16)
