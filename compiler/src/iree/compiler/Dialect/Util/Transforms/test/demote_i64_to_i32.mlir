...
// CHECK-SAME:            %[[ARG0:.*]]: i32) -> i1 {
// CHECK-DAG: %[[VAL0:.+]] = arith.constant 2147483647 : i32
// CHECK-DAG: %[[VAL1:.+]] = arith.select sgt %[[VAL0]], %[[ARG0]] : i32
// CHECK-DAG: %[[VAL2:.+]] = arith.select sgt %[[VAL1]], %[[ARG0]] : i32
func.func @arith.select(%arg0: i64) -> i32 {
  %c1 = arith.constant 1 : i1
  %c9223372036854775807_i64 arith.constant 9223372036854775807 : i64
  %0 = arith.select %c1, %c9223372036854775807_i64, %arg0 : i64
  %1 = arith.cmpi sgt %0, %arg0 : i64
  return %1
}
